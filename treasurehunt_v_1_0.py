...
def userScreen(*args):
	...
	os.system("clear")
	gatesList = list(args)
	print('DEBUG {}'.format(gatesList))

	print('Hello User !\n')
	print('\t\t\t\t\t\t\t\t\tTreasure\n') 
        gates = 'Gate\t\tGate2\t\tGate3\t\tGate4\t\tGate5\t\tGate6\t\tGate7\n' 
	print(gates)
	...
	print('\n')
        ...
        while len(list1) < 4:
          ...
          if entry2 not in list1 and entry3 not in list1:
              list1.append(entry2)
              list1.append(entry3)
          else:
              entry2 = random.randint(1,7)
        ...
        #entry3 = random.randint(1,7)       
        #entry1 = int(input('Choice1 !\n'))
        #entry2 = int(input('Choice2 !\n'))
        #entry3 = int(input('Choice3 !\n'))    

        userScreen2(entry1,entry2,entry3)             
#############################################################################################################################################################################################################   
def userScreen2(*args):
	...
	for item in gatesList:
        ...
        userEntry = [ele1,ele2,ele3]
        print("DEBUG userEntry {}".format(userEntry))
        randGates = [random.randint(1,7),random.randint(1,7),random.randint(1,7)]        
        print("DEBUG randGates {}".format(randGates))
        for i in randGates:
             print('Gate-{} Guarded'.format(i))    
        ...
        if len(intList) == 2:
           print('Sorry Better luck next time, you need to get atleast 2 gates correct ')    
        else:
